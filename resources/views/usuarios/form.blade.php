<div class="col col-12 mt-3">
    ...
    <input  required value="{{ old('idUsuario', $usuario->idUsuario) }}" type="text" name="idUsuario" class="form-control">
</div>
...
<div class="col col-12 mt-3">
    ...
    <input  required value="{{ old('telefono', $usuario->telefono) }}" type="text" name="telefono" class="form-control">
</div>
...
<div class="col col-12 mt-3">
    ...
    <input  required value="{{ old('cedula', $usuario->cedula) }}" type="text" name="cedula" class="form-control">
</div>
